package edu.nyu.cs.alien_invasion;
...
public class Spaceship {
	...
	private final static String SPACESHIP_IMAGE_PATH = "images/spaceship.png"; // image file
	private PImage img; //will hold the image to  use for this spaceship
	
	private int x, y; //position
	private int speedX = 3; //speed in x  direction... start out going to the right
